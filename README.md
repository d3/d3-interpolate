...
2. If *b* is a [color](https://github.com/d3/d3-color#color) or a string coercible to a color, [interpolateRgb](#interpolateRgb) is used.
3. If *b* is a string, [interpolateString](#interpolateString) is used.
