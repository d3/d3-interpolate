...
it("interpolateDate(a, b) interpolates between two dates a and b", () => {
  const i = d3.interpolateDate(new Date(2000, 0, 1), new Date(2000, 0, 2));
...
it("interpolateDate(a, b) gives exact ends for t=0 and t=1", () => {
  ...
  assert.strictEqual(+d3.interpolateDate(a, b)(1), +b);
  assert.strictEqual(+d3.interpolateDate(a, b)(0), +a);
});
